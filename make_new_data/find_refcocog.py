...
def main(argv):
    ...
    outputfile = '/data/huyutao/new_coco/dataset_split_true_round2/refcocog_multargets_2v6big/'  # './data/coco/vis/'
    ...
    refcocog_train_pools = np.load('/data/huyutao/new_coco/dataset_split_true_round2/refcocog_train_names.npy')
    ...
    for i, imgId in enumerate(imgIds):
        ...
        cat_id_area = {}
        cat_small = {}
        if img['file_name'] in refcocog_train_pools:
