...
dir1 = 'input_ms_output_raw'
dir2 = 'model_ms_output_raw'
...
for filename in filename_list:
    ...
    if torch.sum(output_mask1!=output_mask1)>10000:
        output_mask1 = np.array(output_mask1)
        output_mask2 = np.array(output_mask2)
        mask_save = np.concatenate((output_mask1,output_mask2),axis=2)
