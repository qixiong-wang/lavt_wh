...
def RMI_loss(features_1, features_2):
    # pdb.set_trace()
    datasize = features_1.shape[0]

    loss = tensor_cka(tensor_gram_linear(features_1.view(datasize, -1)), tensor_gram_linear(features_2.view(datasize, -1)))
    return 1-loss