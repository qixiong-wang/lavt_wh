...
class ReferDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.image_transforms is not None:
            ...
            if self.split == 'train':
                img0, img1, target0, target1, hflip = self.image_transforms(img, annot)
            elif self.split == 'val':
                img0, img1, target0, target1, = self.image_transforms(img, annot)
                hflip = False
        ...
        return img0, img1, target0, target1, tensor_embeddings, attention_mask