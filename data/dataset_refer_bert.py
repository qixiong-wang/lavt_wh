    ...
    def __init__(self,
        ...
        for r in ref_ids:
            ...
            for i, (el, sent_id) in enumerate(zip(ref['sentences'], ref['sent_ids'])):
                ...
                input_ids = np.array(clip.tokenize(sentence_raw))[0].tolist()
                token_length = len(input_ids) - input_ids.count(0)
                # print(len(input_ids), len(input_ids1))
                ...
                attention_mask[:token_length] = [1]*token_length
                # pdb.set_trace()
