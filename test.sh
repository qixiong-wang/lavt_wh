...
srun --partition=Gvadapt  --mpi=pmi2 --gres=gpu:1 -N 1  --job-name=test --kill-on-bad-exit=1 --pty --quotatype=spot --mail-type=ALL \
python test.py --model lavt --swin_type base --dataset refcoco --split val --model_id test --rootpath /mnt/petrelfs/huyutao/record/lavit_hu1/ \
