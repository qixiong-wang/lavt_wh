...
from some_functions import Nce_contrast_loss
...
def train_one_epoch(model, criterion, contras_cri, optimizer, data_loader, lr_scheduler, epoch, print_freq,
    ...
    for data in metric_logger.log_every(data_loader, print_freq, header):
        ...
        metric_logger.update(loss_seg=loss_seg.item())
...
def main(args):
    ...
    for epoch in range(max(0, resume_epoch+1), args.epochs):
        ...
        train_one_epoch(model, criterion, contras_cri, optimizer, data_loader, lr_scheduler, epoch, args.print_freq,
                        iterations, bert_model)
        iou, overallIoU = evaluate(model, data_loader_test, bert_model)
