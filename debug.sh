...
cp -r ./data /mnt/petrelfs/huyutao/record/lavit_hu1/debug
...
python -m torch.distributed.launch --nproc_per_node 1 --master_port 23334 train_flip.py --model lavt --dataset refcoco \
