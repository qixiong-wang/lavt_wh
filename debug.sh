...
srun --partition=Gvadapt --mpi=pmi2 --gres=gpu:1 -N 1  --job-name=DEBUG --kill-on-bad-exit=1 --pty --quotatype=spot --mail-type=ALL \
python -m torch.distributed.launch --nproc_per_node 1 --master_port 23333 train_noun_conloss.py --model lavt --dataset refcoco \
--model_id debug --batch-size 8 --lr 0.00005 --wd 1e-2 --swin_type base --pretrained_swin_weights ~/pretrained_model/swin_base_patch4_window12_384_22k.pth \
--output-dir /mnt/petrelfs/huyutao/record/lavit_hu1/debug \
--epochs 40 --rootpath /mnt/petrelfs/huyutao/record/lavit_hu1/ --wd 5e-2 --img_size 480 2>&1 | tee /mnt/petrelfs/huyutao/record/lavit_hu1/debug/output
