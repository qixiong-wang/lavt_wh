...
input_path = 'refer/data/images/mscoco/images/train2014/'
test_gt_path = 'vis_target_refcoco+_val_data/'
test_pred_path = 'vis_output_mask_refcoco+_val_data/'
save_path = 'refcoco+_pinjie'
