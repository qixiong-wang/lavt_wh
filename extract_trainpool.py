...
refcoco = open('/data/huyutao/new_coco/ori_refcoco.csv', 'r')
refcoco1 = open('/data/huyutao/new_coco/ori_refcoco+.csv', 'r')
refcocog = open('/data/huyutao/new_coco/ori_refcocog.csv', 'r')

ff = open('/data/huyutao/new_coco/refseg_train_pools.csv', 'w')
ff1 = csv.writer(ff)
ff1.writerow(['index', 'filename'])

ffwo = open('/data/huyutao/new_coco/refseg_train_pools_wotest.csv', 'w')
ffwo1 = csv.writer(ffwo)
ffwo1.writerow(['index', 'filename'])
...
test_pool = np.load('/data/huyutao/new_coco/refseg_test_pools.npy')
...
np.save('/data/huyutao/new_coco/refseg_train_pools.npy', train_list_all)
np.save('/data/huyutao/new_coco/refseg_train_pools_wo_test.npy', train_list_wotest)
